package de.nischwan.acceptandendcalls.activities;
...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static final String DEFAULT_HANGUP_TIME = "50:00";
    ...
    private static final Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof EditTextPreference && preference.getKey().equals(HANG_UP_TIME_KEY)) {
                EditTextPreference editTextPreference = (EditTextPreference) preference;
                if (DateUtils.isValidTime(stringValue)) {
                    editTextPreference.setText(DateUtils.prettifyTime(stringValue));
                } else {
                    return false;
                }
            }
    ...
    public void onBuildHeaders(List<Header> target) {
        // FIXME make header work only on xlarge screens and uncomment the following line
    ...
    public static class CallPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_accept_and_end_call);
